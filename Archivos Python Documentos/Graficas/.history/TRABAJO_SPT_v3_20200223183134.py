...
ax2.figure(figsize=(16, 8), dpi=100)
ax2.subplot(1, 1, 1)
ax2.plot(x1, Vxa, color="blue", linewidth=1.0, linestyle="-")
ax2.plot(x1, Vxb, color="green", linewidth=1.0, linestyle="-")
ax2.xlim(-10, 10)
ax2.xticks(np.linspace(-10, 10, 17, endpoint=True))
ax2.ylim(200.0, 1700.0)
ax2.yticks(np.linspace(200, 1700, 5, endpoint=True))
#pl.pause(100)
