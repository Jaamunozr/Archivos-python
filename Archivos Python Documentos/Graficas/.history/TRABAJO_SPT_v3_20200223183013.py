...
ax2.pl.figure(figsize=(16, 8), dpi=100)
ax2.pl.subplot(1, 1, 1)
ax2.pl.plot(x1, Vxa, color="blue", linewidth=1.0, linestyle="-")
ax2.pl.plot(x1, Vxb, color="green", linewidth=1.0, linestyle="-")
ax2.pl.xlim(-10, 10)
ax2.pl.xticks(np.linspace(-10, 10, 17, endpoint=True))
ax2.pl.ylim(200.0, 1700.0)
ax2.pl.yticks(np.linspace(200, 1700, 5, endpoint=True))
#pl.pause(100)
