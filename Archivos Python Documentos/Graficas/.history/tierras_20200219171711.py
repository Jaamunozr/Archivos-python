...
surf=axx.plot_surface(X, Y, Vt, rstride=1, cstride=1, cmap=pl.cm.hot)
axx.xaxis.set_major_locator(MaxNLocator(5)) #Here line I don't understand
axx.yaxis.set_major_locator(MaxNLocator(6)) #Here line I don't understand
axx.zaxis.set_major_locator(MaxNLocator(5)) 
