...
'''TENER PRESENTE QUE LAS COORDENADAS DE INICIO Y FIN DE LAS LINEAS PUNTEADAS SE ESCRIBEN COMO:
...
pl.pause(10)
pl.savefig('Sinusoida.svg')
pl.savefig('Sinusoida.pdf')
pl.savefig('Sinusoida.png')