...
puntoX=input("Seleccione la coordenada en X donde desea calcular el potencial: \n \n")
puntoY=input("\nSeleccione la coordenada en Y donde desea calcular el potencial: \n \n")
print("\nCalculando ... \n")
...
while i<=E:
    ...
    #print("Elementos de matriz",k,t, "x,y",P[i][0],P[i][1],"punto de eje",X,Y )
        m2[i][0]=Rad
    V2[i][0] =ln((l+raiz((m[i][0])**2+l**2))/(m2[i][0]))
    i += 1
Vt2=np.sum(V2)
